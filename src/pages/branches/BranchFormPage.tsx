  ...
  return (
    <div className="vision-form-wrapper">
      ...
      <div className="vision-header">
        ...
        <h4 className="vision-title">{isEdit ? 'Edit Branch details' : 'Create new Branch'}</h4>
      </div>
      ...
      <div className="vision-form-card">
        <form onSubmit={handleSubmit((data) => mutation.mutate(data))}>
          ...
          <div className="vision-form-group">
            ...
            <input
              className={`vision-input ${errors.location ? 'is-invalid' : ''}`}
          ...
          <div className="vision-form-group">
            <label className="vision-label">Branch Manager</label>
            <div className="vision-select-wrapper">
              <select className="vision-select" {...register('manager_id', { valueAsNumber: true })}>
          ...
          {mutation.isError && (
            <div className="vision-alert-danger">
              ...
              <span>Failed to save the branch. Please check your connection and try again.</span>
            </div>
          )}
