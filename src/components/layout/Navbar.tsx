...
export default function Navbar({ collapsed, onToggle }: NavbarProps) {
  ...
  return (
    <>
      ...
      <header
        className="navbar-vision-light d-flex align-items-center px-4"
        style={{
          height: 72,
          position: 'fixed',
          top: 0,
      ...
      >
        ...
        >
          <i className="bi bi-layout-sidebar" style={{ fontSize: 20 }} />
        </button>
        ...
        <div className="flex-grow-1" style={{ maxWidth: 460 }}>
          <div className="spotlight-search d-flex align-items-center px-3 py-1">
            ...
            <input
              type="search"
              className="form-control spotlight-input"
              placeholder="Search workspaces, reports, or users..."
            />
            <div 
        ...
        <div className="ms-auto d-flex align-items-center gap-2">
          ...
          <div style={{ width: 1, height: 24, background: 'rgba(0,0,0,0.06)', margin: '0 8px' }} />

          {/* User Profile Dropdown */}
          <div className="dropdown">
            <button
              className="btn d-flex align-items-center gap-3 p-1 pe-2"
            ...
            >
              ...
              <div className="text-start d-none d-md-block" style={{ marginTop: '-2px' }}>
              ...
              <i className="bi bi-chevron-down d-none d-md-block" style={{ fontSize: 11, color: '#A1A1AA', strokeWidth: 2 }} />
            </button>
